...
namespace BMS.Utils
{
    public class CommunicationManager
    {
        ...
        public CommunicationManager(string baud, string par, string sBits, string dBits, string name, Control tb)
        {
            _baudRate = baud;
            _parity = par;
            _stopBits = sBits;
        ...
        private void DisplayData(MessageType type, string msg)
        {
            ...
            {
                _displayWindow.Text = _displayWindow.Text + msg;
            }));
        }
        #endregion
        ...
        public void comPort_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            ...
            switch (CurrentTransmissionType)
            {
                ...
                case TransmissionType.Text:
                    ...
                    DisplayData(MessageType.Incoming, data);
                    break;
                //user chose binary
                //case TransmissionType.Hex:
