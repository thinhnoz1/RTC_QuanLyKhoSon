...
namespace Test
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.button3.Text = "Run 1";
			this.button3.UseVisualStyleBackColor = true;
			this.button3.Click += new System.EventHandler(this.button3_Click);
			// 
			// button4
			// 
			this.button4.Location = new System.Drawing.Point(219, 27);
			this.button4.Name = "button4";
			this.button4.Size = new System.Drawing.Size(83, 32);
			this.button4.TabIndex = 6;
			this.button4.Text = "Run 2";
			this.button4.UseVisualStyleBackColor = true;
			this.button4.Click += new System.EventHandler(this.button4_Click);
			// 
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(308, 27);
			this.button5.Name = "button5";
			this.button5.Size = new System.Drawing.Size(83, 32);
			this.button5.TabIndex = 7;
			this.button5.Text = "Run 3";
			...
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(397, 27);
			this.button6.Name = "button6";
			this.button6.Size = new System.Drawing.Size(150, 32);
			this.button6.TabIndex = 11;
			this.button6.Text = "Run 4 With Thread";
